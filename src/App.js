...
function App() {
  ...
  return (
    <div className="bg-gradient-to-b from-voltaris-bg via-voltaris-soft-bg to-voltaris-bg text-voltaris-text min-h-screen relative">
      ...
      <button 
        className="md:hidden text-voltaris-dark focus:outline-none fixed top-5 right-4 z-[9999] mobile-menu-button" 
            ...
            <div className="space-y-2 mt-2 menu-items-container" style={{ display: 'block', visibility: 'visible', opacity: 1 }}>
              {['home', 'about', 'technical', 'sponsors', 'contact'].map((section) => (
                <div key={section}>
                  ...
                  ${activeSection === section || (section === 'technical' && (activeSection === 'vehicle' || activeSection === 'adas')) 
                  ? 'bg-gray-100 text-blue-700 border-l-2 border-blue-500' 
                  ...
                  >
                    ...
                    {section === 'technical' && <ChevronDown size={16} className={`transition-transform duration-300 text-gray-500 ${mobileSubmenuOpen ? 'transform rotate-180' : ''}`} />}
                  </button>
                  
                  {section === 'technical' && mobileSubmenuOpen && (
                    <div className="ml-4 mt-1 mb-3 space-y-1 border-l border-gray-200 pl-3 mobile-submenu visible" 
                      style={{
                        display: 'block',
                        visibility: 'visible',
                        opacity: 1,
